      ...
      <section className="border-b border-zinc-800 py-16 md:py-20">
        <div className="container mx-auto max-w-6xl px-4 md:px-6">
          ...
          <p className="text-zinc-400 text-lg max-w-xl leading-relaxed">
            Comprehensive exterior services performed by experienced,
            licensed professionals. Every project, every time.
          </p>
        </div>
      </section>
      ...
      {services.map((service, index) => {
        ...
        return (
          <section
            key={service.id}
            id={service.id}
            className={`py-20 md:py-24 border-t border-zinc-900`
			// 	${
      ...
      <section className="bg-yellow-500 py-16 md:py-20">
        <div className="container mx-auto max-w-6xl px-4 md:px-6 text-center">
          ...
          <p className="text-yellow-900 text-lg mb-8 max-w-lg mx-auto">
            We&apos;ll assess your home and recommend the best solution — at no cost
