        ...
        <div className="relative container mx-auto max-w-6xl px-4 md:px-6 py-20 md:py-28 lg:py-36">
          <div className="max-w-3xl">
            ...
            <p className="text-zinc-400 text-lg md:text-xl leading-relaxed mb-8 max-w-xl">
              Expert roofing, siding, and gutter services delivered with
              precision and care. We stand behind every job we do.
            </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            {stats.map((stat) => (
              <div key={stat.label}>
                ...
                <div className="text-yellow-900 font-medium text-sm mt-1">
                  {stat.label}
                </div>
              </div>
            ))}
        ...
        <div className="container mx-auto max-w-6xl px-4 md:px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-zinc-400 mt-3 max-w-xl mx-auto">
              From roof to foundation, we keep the exterior of your home in
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-zinc-400 leading-relaxed mb-8">
                We&apos;ve built our reputation one rooftop at a time. Every project
                gets the same focus, care, and expertise — whether it&apos;s a small
                repair or a full exterior renovation.
              </p>
              <Button
                asChild
      ...
      <section className="bg-yellow-500 py-16 md:py-20">
        <div className="container mx-auto max-w-6xl px-4 md:px-6 text-center">
          ...
          <p className="text-yellow-900 text-lg mb-8 max-w-xl mx-auto">
            Contact us today for a free, no-obligation quote. We&apos;ll come to you
            and walk through every detail.
          </p>
